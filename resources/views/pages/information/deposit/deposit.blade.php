                                            ...
                                            <div class="transaction-image-container">
                                                @if ($deposit->image)
                                                    <a href="{{ Storage::url($deposit->image) }}" target="_blank"
                                                        ...
                                                        <img src="{{ Storage::url($deposit->image) }}" alt="Biên lai"
                                            ...
                                            <div class="transaction-details">
                                                ...
                                                <div class="transaction-detail">
                                                    ...
                                                    <div class="transaction-detail-value">
                                                        {{ number_format($deposit->amount) }} VNĐ</div>
                                                </div>

                                                <div class="transaction-detail">
                                                    <div class="transaction-detail-label">Xu</div>
                                                    <div class="transaction-detail-value">
                                                        {{ number_format($deposit->coins) }}</div>
                                                </div>
                                                ...
                                                @if ($deposit->approved_at)
                                                    <div class="transaction-detail">
                                                        ...
                                                        <div class="transaction-detail-value">
                                                            {{ $deposit->approved_at->format('d/m/Y H:i') }}</div>
                                                    </div>
                                                @endif
                                            </div>
    ...
    <div class="modal fade" id="uploadEvidenceModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="evidenceForm" action="{{ route('user.deposit.store') }}" method="POST"
    ...
    @push('info_scripts')
        <script>
            ...
            $('#confirmPaymentBtn').on('click', function() {
                ...
                $('#evidenceAmount').val(window.paymentInfo.amount);
                $('#evidenceTransactionCode').val(window.paymentInfo.transactionCode);
                $('#evidenceCoins').val(window.paymentInfo.totalCoins);
